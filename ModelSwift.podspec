...
Pod::Spec.new do |s|
  s.name             = 'ModelSwift'
  s.version          = '0.1.0'
  s.summary          = 'A short description of ModelSwift.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/huluobobo/ModelSwift'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'huluobobo' => 'hujewelz@163.com' }
  s.source           = { :git => 'https://github.com/huluobobo/ModelSwift.git', :tag => s.version.to_s }
